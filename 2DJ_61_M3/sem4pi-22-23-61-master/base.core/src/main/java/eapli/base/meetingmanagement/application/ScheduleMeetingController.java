...
public class ScheduleMeetingController {
    ...
    public Meeting saveMeeting(final MeetingDuration meetingDuration, final MeetingDate meetingDate, final MeetingTime meetingTime){
        return meetingRepository.save(new Meeting(meetingDuration, meetingDate, meetingTime));
    }
